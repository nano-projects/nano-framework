...
public final class URIBuilder {
    ...
    private String encodeUserInfo(final String userInfo) {
        return this.encode ? ServiceUtils.urlEncode(userInfo) : userInfo;
    }

    private String encodePath(final String path) {
        return this.encode ? ServiceUtils.urlEncode(path) : path;
    }

    private String encodeUrlForm(final List<BasicNameValuePair> params) {
        final StringBuilder result = new StringBuilder();
        for (final BasicNameValuePair parameter : params) {
            final String encodedName = this.encode ? ServiceUtils.urlEncode(parameter.getName()) : parameter.getName();
    ...
    private String encodeUric(final String fragment) {
        return this.encode ? ServiceUtils.urlEncode(fragment) : fragment;
    }

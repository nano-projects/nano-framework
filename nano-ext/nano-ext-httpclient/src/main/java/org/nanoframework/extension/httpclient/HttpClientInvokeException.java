...
public class HttpClientInvokeException extends RuntimeException {
     ...
     */
    public HttpClientInvokeException(String message) {
        super(message);
    }
     ...
     * @since  1.4
     */
    public HttpClientInvokeException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since  1.4
     */
    public HttpClientInvokeException(Throwable cause) {
        super(cause);
    }

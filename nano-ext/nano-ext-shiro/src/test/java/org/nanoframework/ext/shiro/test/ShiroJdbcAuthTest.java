...
public class ShiroJdbcAuthTest {
    private static final Logger LOGGER = LoggerFactory.getLogger(ShiroJdbcAuthTest.class);
    ...
    public void test0() {
        ...
        try {
            ...
            LOGGER.error("Authentication Invalid: " + e.getMessage());
        }
        ...
        try {
            ...
            LOGGER.error("Check permission error: " + e.getMessage());
        }
        ...
        try {
            ...
            LOGGER.error("Check roles error: " + e.getMessage());
        }

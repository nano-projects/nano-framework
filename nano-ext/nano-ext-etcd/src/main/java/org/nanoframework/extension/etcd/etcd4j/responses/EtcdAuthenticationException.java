...
import org.nanoframework.extension.etcd.etcd4j.responses.EtcdResponseDecoders.StringToObjectDecoder;
...
public class EtcdAuthenticationException extends Exception {
	private static final long serialVersionUID = -7652127204068403550L;

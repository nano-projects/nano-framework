...
import org.nanoframework.extension.etcd.client.exceptions.PrematureDisconnectException;
...
class EtcdResponseHandler<R> extends SimpleChannelInboundHandler<FullHttpResponse> {
  ...
  static {
    failureDecoders = new HashMap<HttpResponseStatus, EtcdResponseDecoder<? extends Throwable>>();

...
import org.nanoframework.extension.etcd.etcd4j.requests.EtcdKeyDeleteRequest;
import org.nanoframework.extension.etcd.etcd4j.requests.EtcdKeyGetRequest;
import org.nanoframework.extension.etcd.etcd4j.requests.EtcdKeyPostRequest;
import org.nanoframework.extension.etcd.etcd4j.requests.EtcdKeyPutRequest;
import org.nanoframework.extension.etcd.etcd4j.requests.EtcdLeaderStatsRequest;
import org.nanoframework.extension.etcd.etcd4j.requests.EtcdOldVersionRequest;
import org.nanoframework.extension.etcd.etcd4j.requests.EtcdSelfStatsRequest;
import org.nanoframework.extension.etcd.etcd4j.requests.EtcdStoreStatsRequest;
import org.nanoframework.extension.etcd.etcd4j.requests.EtcdVersionRequest;
...
import org.nanoframework.extension.etcd.etcd4j.transport.EtcdNettyClient;
...
public class EtcdClient implements Closeable {
	...
	/**
	 * Set the retry handler. Default is an exponential back-off with start of
	 * 20ms.
	 *
	 * @param retryHandler
	 *            to set

...
import org.nanoframework.orm.jedis.cluster.HashTests;
 ...
 * @since 1.3.15
 */
public class ShardedInfoTests {
    private static final Logger LOGGER = LoggerFactory.getLogger(HashTests.class);

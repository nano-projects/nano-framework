...
public abstract class AbstractRedisClient implements RedisClient {
    ...
    @Override
    public <T> Set<T> zrangeByLex(final String key, final String min, final String max, final int offset, final int count, final TypeReference<T> type) {
    ...
    @Override
    public <T> Set<T> zrangeByScore(final String key, final double min, final double max, final int offset, final int count, final TypeReference<T> type) {
    ...
    @Override
    public <T> Set<T> zrangeByScore(final String key, final String min, final String max, final int offset, final int count, final TypeReference<T> type) {
    ...
    @Override
    public <T> Map<T, Double> zrangeByScoreWithScores(final String key, final double min, final double max, final int offset, final int count, final TypeReference<T> type) {
    ...
    @Override
    public <T> Set<T> zrevrangeByLex(final String key, final String max, final String min, final int offset, final int count, final TypeReference<T> type) {
    ...
    @Override
    public <T> Set<T> zrevrangeByScore(final String key, final double max, final double min, final int offset, final int count, final TypeReference<T> type) {

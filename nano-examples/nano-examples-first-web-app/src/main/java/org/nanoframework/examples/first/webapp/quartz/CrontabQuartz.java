 ...
 */
@Quartz(name = "CrontabQuartz", beforeAfterOnly = true, interval = 5000, parallel = 1)
public class CrontabQuartz extends BaseQuartz {
	...
	public void execute() throws QuartzException {
		LOG.debug("当前时间: " + DateFormatUtils.format(System.currentTimeMillis(), Pattern.TIMESTAMP.get()));
	}
